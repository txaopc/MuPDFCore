...
namespace MuPDFCore.MuPDFRenderer
{
    public partial class PDFRenderer : Control
    {
        ...
        public static readonly StyledProperty<bool> SignEnabledProperty = AvaloniaProperty.Register<PDFRenderer, bool>(nameof(SignEnabled), false);
        ...
        {
            get { return GetValue(SignEnabledProperty); }
    ...
    /// <summary>
    /// <see cref="EventArgs"/> for the <see cref="PDFRenderer.SignClicked"/> event.
    /// </summary>
    public class SignClickedEventArgs : EventArgs
    {
        /// <summary>
        ...
        /// <summary>
        /// Provides data for the event that occurs when a sign is clicked in a document.
        /// </summary>
        /// <param name="x">The x-coordinate of the click position, in document units.</param>
        /// <param name="y">The y-coordinate of the click position, in document units.</param>
        /// <param name="page">The page number where the click occurred. Must be greater than or equal to 1.</param>
        public SignClickedEventArgs(double x, double y, int page)
        {
            X = x;
            Y = y;
            Page = page;
